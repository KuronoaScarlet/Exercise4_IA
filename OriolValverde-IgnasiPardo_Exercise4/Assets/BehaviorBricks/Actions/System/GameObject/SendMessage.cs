...
namespace BBUnity.Actions
{
    ...
    public class SendMessage : GOAction
    {
        ...
        public override void OnStart()
        {
            ...
            GameObject.FindGameObjectsWithTag("Cop").Where(x => x.GetComponent<Moves>().found == true).First().GetComponent<Moves>().BBSeek(targetGameobject);

            var l = GameObject.FindGameObjectsWithTag("Cop").Where(x => x.GetComponent<Moves>().found == false);
